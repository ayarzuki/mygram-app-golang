...
type RegisterUser struct {
	...
	ProfileImageURL string `json:"profile_image_url" valid:"required~Field Profile Image URL is required,maxstringlength(255)~Field Profile Image URL maximum length is 255 characters,type(string)~Field Profile Image URL must be string"`
}
